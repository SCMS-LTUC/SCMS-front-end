  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-between gap-5">    
        <button type="submit" className="bg-green-500 text-white px-4 py-2 rounded-md w-1/2">
          Save changes
        </button><button type="submit" className="bg-green-500 text-white px-4 py-2 rounded-md w-1/2">
          Delete Assignment
        </button>
      </div>
    </form>
