    ...
    return (
        <div className='w-full h-[80px] bg-white border-b'>
            <div className='md:max-w-[1480px] max-w-[600px] m-auto w-full h-full flex justify-between items-center md:px-0 px-4'>
                ...
                ><img src={logo} className="h-[50px] w-[50px]" /> </span>
            ...
            <div className={toggle ? 'absolute z-10 p-4 bg-white w-full px-8 md:hidden border-b' : 'hidden'}>
                <ul>
                    <li className='p-4 hover:bg-gray-100' onClick={() => handleNavigation('/')}>Home</li>
                    <li className='p-4 hover:bg-gray-100' onClick={() => handleNavigation('/about-us')}>About</li>
                    <li className='p-4 hover:bg-gray-100' onClick={() => handleNavigation('/courses')}>Courses</li>
                    <li className='p-4 hover:bg-gray-100' onClick={() => handleNavigation('/contact-us')}>Contact Us</li>
