        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <div className="container mx-auto p-6 md:p-12 bg-white rounded-lg shadow-lg ">
                ...
                <div className="mt-12 mb-28">
                    <h3 className="text-3xl font-bold text-center text-[#20B486] mb-6 relative">
                        <span className="inline-block pb-2 border-b-4 border-[#20B486]">
                            Our Location
                        </span>
                    </h3>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start">
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left md:pl-8">
                        <h2 className="text-4xl font-bold text-[#20B486] mb-4">
                            Get in Touch with Us!
                        </h2>
                        <p className="text-gray-600 mb-6">
                            Have questions? We’re here to help! Reach out to us and our team will
                            get back to you as soon as possible. We’d love to hear from you!
                        </p>
                        <div className="space-y-4">
                            <div className="flex items-center justify-center md:justify-start">
                                <i className="fas fa-phone text-[#20B486] text-2xl mr-4"></i>
                                <p className="text-gray-800 text-lg">+123-456-7890</p>
                            </div>
                            <div className="flex items-center justify-center md:justify-start">
                                <i className="fas fa-envelope text-[#20B486] text-2xl mr-4"></i>
                                <p className="text-gray-800 text-lg">support@example.com</p>
                            </div>
                            <div className="flex items-center justify-center md:justify-start">
                                <i className="fas fa-map-marker-alt text-[#20B486] text-2xl mr-4"></i>
                                <p className="text-gray-800 text-lg">123 Green Street, City, Country</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12">
                    <h3 className="text-3xl font-bold text-center text-[#20B486] mb-6">
                        Send Us a Message
                    </h3>
                ...
                <div className="mt-12 text-center">
                    ...
                    <div className="flex justify-center space-x-6">
                        <a
                            href="#"
                            className="text-[#20B486] text-2xl hover:text-gray-600">
