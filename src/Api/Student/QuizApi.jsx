...
export const submitQuiz = createAsyncThunk(
    ...
    async (quizSubmission, { rejectWithValue }) => {
        try {
            const response = await baseUrl.post(`/StudentAnswer/post-quiz-result`, quizSubmission, {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
                },
...
export const calculateScore = createAsyncThunk(
    ...
    async (quizId, { rejectWithValue }) => {
      try {
        ...
        const response = await baseUrl.post(`/StudentAnswer/calculate-score?quizId=${quizId}`, null, {
          headers: {
            "Content-Type": "application/json",
